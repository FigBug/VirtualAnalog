...
{
public:
    LFOArea (VirtualAnalogAudioProcessor& proc_, int idx_)
        : proc (proc_), idx (idx_)
    {
        auto& lfo = proc.lfoParams[idx];
...
{
public:
    GateBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    ChorusBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    DistortBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    EQBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    CompressBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    DelayBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    ReverbBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    LimitBox (VirtualAnalogAudioProcessor& proc_)
...
{
public:
    ScopeArea (VirtualAnalogAudioProcessor& proc_)
